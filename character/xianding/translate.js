...
const translates = {
	...
	dczhiti: "止啼",
	dczhiti_info: "锁定技，摸牌阶段你多摸X张牌（X为场上所有被废除的装备栏数）；其他角色弃牌阶段结束时，若其有被废除的装备栏，你可弃置其区域内等量张牌。",
	dc_shen_caopi: "新杀神曹丕",
	...
	dccili: "慈厉",
	dccili_info: "每轮开始时，你可记录一名角色的体力值。直到下回合结束时，若其此期间使用的牌数小于/不小于记录值，你可以令其随机弃置/摸记录值张牌（至多五张）。",
	caohua: "曹华",
	caiyi: "彩翼",
