...
const translates = {
	...
	sb_zhanghe: "谋张郃",
	sbqiaobian: "巧变",
	sbqiaobian_info: "准备阶段，你可弃置任意张不同区域内的牌，然后跳过等量个阶段，并于跳过对应阶段后可以执行相应效果。若你以此法跳过：1.摸牌阶段，你可以获得至多两名其他角色各一张手牌；2.出牌阶段，你可以移动场上一张牌，然后若你装备区内的牌数未增加，则你可令因此场上牌数增加的角色摸两张牌；3.弃牌阶段，你摸一张牌，结束阶段，若你手牌数不小于场上角色数，你执行一个额外的出牌阶段。",
	sbliaoshi: "料势",
