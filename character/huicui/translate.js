const translates = {
	...
	dcbinji: "镔济",
	dcbinji_info: "每轮开始时，你可交给至多三名其他角色各一张黑色牌，这些角色失去这些牌时从牌堆或弃牌堆随机获得一张武器牌，然后你摸两张牌。",
	dczangmao: "驵贸",
	dczangmao_info: "出牌阶段限三次，你可以：1.弃置一张方块牌，然后从牌堆或弃牌堆随机获得一张坐骑牌；2、交给一名其他角色一张方块牌，然后获得其装备区一张坐骑牌；3、将一张坐骑牌置入一名其他角色装备区， 然后随机获得其至多两张方块手牌。",
	dc_weifeng: "新杀魏讽",
	dc_weifeng_prefix: "新杀",
	dchuozhong: "惑众",
	dchuozhong_info: "出牌阶段限一次，你可以展示一张手牌并令攻击范围内任意名其他角色获得或交给另一名角色一张牌，然后手牌数最多的其他角色展示手牌并将所有与你展示牌类型相同的牌置于牌堆顶。若其因此手牌数变为最少，本回合此技能改为出牌阶段限两次。",
	dczhuguo: "蛀国",
	dczhuguo_info: "锁定技，一名角色的牌进入牌堆后，你从牌堆底摸两张牌。",
};
