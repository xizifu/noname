...
const translates = {
	...
	rekongsheng: "箜声",
	rekongsheng_info: "准备阶段、当你失去或回复体力后，你可以将当前回合角色（若没有，则对执行最后一回合的角色发动）的任意张牌置于武将牌上。若如此做，该角色的结束阶段，你选择是否使用其中一张牌，然后其获得其余的牌。当你死亡时，所有角色收回其“箜声”牌。",
	re_yanyan: "手杀界严颜",
	re_yanyan_prefix: "手杀界",
	rejuzhan: "拒战",
	rejuzhan_info: `转换技，游戏开始时，若你的势力为蜀，你的初始状态为阴；阳：当你或者此状态下第三次有角色成为【杀】的目标后，你可以与此【杀】的使用者各摸一张牌，然后其本回合不能对你使用牌；阴：当你或者此状态下第三次有角色使用【杀】指定目标后，你可以获得此【杀】的目标角色一张牌，然后你本回合不能对其使用牌。${get.poptip("rule_chengshi")}：你于出牌阶段内使用【杀】的次数+1，且此【杀】结算完毕后，你获得之。`,
	mb_gaoxiang: "手杀高翔",
	...
	mb_lingju_prefix: "手杀",
	mbjieyuan: "竭缘",
	mbjieyuan_info: `你造成伤害时，你可以选择一项：1、弃置一张黑色牌，令此伤害+1；2、从牌堆中获得一张黑色牌。你受到伤害时，你可以选择一项：1、弃置一张红色牌，令此伤害-1；2、从牌堆中获得一张红色牌。${get.poptip("rule_beishui")}：删除另一个时机的效果，将伤害的增减、获得牌的数量改为2，然后失去背水选项。`,
	mbfenxin: "焚心",
