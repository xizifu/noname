...
const translates = {
	...
	sbjieyin: "结姻",
	sbjieyin_info: `使命技，你的登场势力为蜀，游戏开始时，你将一名其他角色选择为结姻角色。结姻角色死亡后，你减一点体力上限；结姻角色的出牌阶段开始时，你选择一项：1.令其获得一点护甲；2.你将势力变更为吴，然后获得其X张牌（X为游戏轮数且至多为3）。成功：若结姻角色护甲值为5，你每轮首次发动${get.poptip("sbxiaoji")}后，获得1点护甲。成功：若结姻角色拥有4个装备，你发动${get.poptip("sbxiaoji")}后，本回合使用【杀】的次数+1。失败：若结姻角色死亡或你的势力为吴，你清除结姻标记，重铸所有红桃手牌，然后摸两张牌。`,
	sbliangzhu: "良助",
