...
const translates = {
	...
	dcsbmingshi: "明势",
	dcsbmingshi_info: "摸牌阶段，你可以多摸两张牌，然后此阶段结束时，你展示三手张牌并令一名其他角色选择获得其中的一张牌。",
	dcsbmengmou: "盟谋",
	...
	dcjuewu: "绝武",
	dcjuewu_two: "2点",
	dcjuewu_info: `①每回合每种牌名限一次。你可以将一张点数为2的牌当任意伤害类牌使用（包括${get.poptip("shuiyanqijuny")}）。②当你得到其他角色的手牌后，你令这些牌的点数均视为2直到你失去这些牌。`,
	dcwuyou: "武佑",
