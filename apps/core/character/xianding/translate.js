...
const translates = {
	...
	dcyinzhi: "阴鸷",
	dcyinzhi_info: "出牌阶段限一次，你可以选择一名其他角色，该角色所有非锁定技失效直到其回合开始，且在此期间，其每次使用或打出手牌后你摸X张牌（X为本局游戏你对其发动〖阴鸷〗的次数且至多为3）。然后其回合内只能使用或打出本回合获得的牌，若其对你造成伤害，则此效果消失且X对其重置。",
	dckeming: "刻名",
	...
	tianren: "天任",
	tianren_info: "锁定技。①当有一张基本牌或普通锦囊牌不因使用而进入弃牌堆后，你获得1枚“天任”标记。②当你获得“天任”标记或体力上限变化后，若你的“天任”数不小于X，则你移去X枚“天任”，加1点体力上限并摸两张牌（X为你的体力上限）。",
	pingxiang: "平襄",
	...
	dcsbmingshi: "明势",
	dcsbmingshi_info: "摸牌阶段，你可以多摸两张牌，然后此阶段结束时，你展示三张手牌并令一名其他角色选择获得其中的一张牌。",
	dcsbmengmou: "盟谋",
	...
	huzun: "胡遵",
	dczhantao: "斩涛",
	dczhantao_info: "当你或你攻击范围内的角色受到渠道为牌A造成的伤害后，若你不为伤害来源且且X为数字（若牌A为转化牌，则X为此牌所有实体牌的点数之和，否则X为此牌的点数），你可以判定，若判定结果点数大于X，你视为对伤害来源使用一张【杀】。",
	dcanjing: "安境",
	...
	dcwuyou: "武佑",
	dcwuyou_info: "①出牌阶段限一次。你可以选择一张手牌，从系统随机生成的五个非装备牌牌名中选择一个，令此牌的牌名与属性视为与你选择的相同。②其他角色的出牌阶段限一次。其可以交给你一张手牌，然后你可以从系统随机生成的五个非装备牌牌名中选择一个牌名并交给其一张手牌，令此牌的牌名与属性视为与你选择的相同（一名角色使用〖武佑〗转化的牌无距离且无任何次数限制）。",
	dcyixian: "义贤",
	...
	dcsbchuanyu: "传舆",
	dcsbchuanyu_tag: "舆",
	dcsbchuanyu_info: "①每轮开始时，你可以交给一名角色一张牌，称为“舆”。②当“舆”因使用进入弃牌堆时，你可以将之交给本轮未获得过“舆”的一名角色，称为“舆”。③每轮结束时，你弃置所有弃置“舆”，然后可以令本轮所有获得过“舆”的角色依次视为对你指定的一名角色使用一张无距离限制的【杀】。",
	dcsbyitou: "倚投",
	...
	v_liubei_prefix: "威",
	dcliexiang: "烈骧",
	dcliexiang_info: "出牌阶段限一次，你可摸至多五张牌并对一名其他角色造成1点伤害，若你的手牌数：1.大于其，本回合你出【杀】次数+1且可以交给一名其他角色至多X张牌；2.等于其，你获得其一张牌且其下回合使用的前X张牌无效；3.小于其，你失去X点体力，此技能本回合修改为“出牌阶段限两次”且可额外选择至多X名其他角色（X为你选择的摸牌数）。",
	dcrengou: "仁彀",
	...
	dcczchouxi: "仇隙",
	dcczchouxi_info: "限定技。出牌阶段或受到伤害后，你可以视为使用一张无任何次数限制的牌名字数至多为X的伤害牌（X为此技能本轮的发动次数）。你以此法使用牌时，可以额外指定任意名本轮对你造成过伤害的角色为目标。当你弃置手牌时，若弃置的手牌数不小于你的手牌数，此技能视为未发动过。",
};
